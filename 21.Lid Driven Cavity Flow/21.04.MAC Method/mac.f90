...
!!!    This program sloves Lid Driven Cavity Flow problem using Marker and Cell Method
...
!!! output data file
        ...
        write(*,*) 'using Marker and Cell Method'
        write(*,*) 'N =',N,',       M =',M
        write(*,*) 'Re =',Re
        write(*,*) 'dt =',dt
        write(*,*) 'eps =',eps
...
!!! output data file
        ...
        do j=1,M
            do i = 1,N
                write(02,100) X(i), Y(j), uc(i,j), vc(i,j), psi(i,j), pc(N,M)
            enddo
        enddo
